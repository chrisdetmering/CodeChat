...
//ACTION UNION
type KnownAction = RequestMessagesAction | ReceiveMessagesAction | ReceiveMessageAction | DeleteMessageSuccessAction | MessagesError | ClearMessagesError
...
export const editMessage = (message: Message): AppThunkAction<KnownAction> => async (dispatch) => {
    console.log(message)
